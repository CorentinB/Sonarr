...
namespace NzbDrone.Core.Test.MediaFiles.EpisodeImport.Specifications
{
    ...
    public class MatchesFolderSpecificationFixture : CoreTest<MatchesFolderSpecification>
    {
        ...
        public void should_be_accepted_if_both_file_and_folder_info_map_to_same_special()
        {
            ...
            Mocker.GetMock<IParsingService>()
                .Setup(v => v.ParseSpecialEpisodeTitle(fileInfo, It.IsAny<string>(), 0, 0, null, 0, null))
                .Returns(actualInfo);

            Mocker.GetMock<IParsingService>()
                .Setup(v => v.ParseSpecialEpisodeTitle(folderInfo, It.IsAny<string>(), 0, 0, null, 0, null))
                .Returns(actualInfo);
